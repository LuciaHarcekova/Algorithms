...
Output: 3
Explanation:
Start at station 3 (index 3) and fill up with 4 unit of gas. Tank = 0 + 4 = 4
...
next station. Let's start at station 2 and fill up with 4 unit of gas.
Your tank = 0 + 4 = 4
